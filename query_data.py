...
# TODO: make sure I am taking advantage of the back ref relationships, point out where I am using them!!
### USER TABLE QUERIES ###
print("First 5 users:")
...
if user1:
    foods_user_ate_yesterday = (
        ...
        .filter(FoodLog in user1.food_log, FoodLog.date == query_date)
    ).all()
